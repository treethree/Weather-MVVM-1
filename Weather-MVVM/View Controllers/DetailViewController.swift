...
class DetailViewController: UIViewController {
    ...
    @IBOutlet weak var hiLowTempLbl: UILabel!
    
    @IBOutlet weak var winImgView: UIImageView!
    @IBOutlet weak var tempImgview: UIImageView!
    
    var temp = "" ,desc = "",city = "",wind = "",hilowTemp = ""
    ...
    func setupCard() {
        ...
        let tapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(DetailViewController.handleCardTap(recognzier:)))
